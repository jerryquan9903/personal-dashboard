<template>
  <a
    class="flex flex-row items-start w-full rounded-sm bg-matteblack-800 p-2 outer-shadow cursor-pointer"
...
export default {
  ...
  beforeMount() {
    this.published = dayjs(this.data.publishedAt).format("MMM D, YYYY");
  },
};
</script>
