<template>
  <div class="flex flex-col justify-center rounded h-full">
    <div class="text-lg font-bold">Hourly</div>
    <div class="flex flex-row overflow-x-scroll custom-scrollbar-x mt-2 bg-background-light rounded outer-shadow">
    ...
    <div class="flex flex-row flex-1 justify-evenly mt-2 bg-background-light rounded outer-shadow">
