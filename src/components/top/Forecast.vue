<template>
  <div class="flex flex-col justify-center rounded h-full p-2">
    ...
    <div class="flex flex-row overflow-x-scroll custom-scrollbar-x mt-1 bg-matteblack-100 rounded outer-shadow">
    ...
    <div class="flex flex-row flex-1 justify-evenly mt-1 bg-matteblack-100 rounded outer-shadow">
